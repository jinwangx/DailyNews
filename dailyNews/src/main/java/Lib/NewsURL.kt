...
object NewsURL {
    ...
    fun getTag(type: String): String? {
        val tag: String?
        when (type) {
            URL_HTTP_GUONEI -> tag = "BD29LPUBwangning"
            URL_HTTP_WORLD -> tag = "BD29MJTVwangning"
            URL_HTTP_SHEHUI -> tag = "BCR1UC1Qwangning"
            URL_HTTP_HISTORY -> tag = "C275ML7Gwangning"
            URL_HTTP_ENTERTAINMENT -> tag = "BA10TA81wangning"
            URL_HTTP_ECONOMIC -> tag = "BA8EE5GMwangning"
            URL_HTTP_EDU -> tag = "BA8FF5PRwangning"
            URL_HTTP_GAME -> tag = "BAI6RHDKwangning"
            URL_HTTP_WAR -> tag = "BAI67OGGwangning"
            URL_HTTP_SPORTS -> tag = "BA8E6OEOwangning"
            URL_HTTP_OWN -> tag = "BAI5E21Owangning"
            else -> tag = null
        }
        return tag
    }
